...
class UserProfile(Base):
    ...
    reviews_user: Mapped[List['Review']] = relationship('Review',
                                                        back_populates='User',
...
class SubCategory(Base):
    ...
    sub_category_product: Mapped[List['Product']] = relationship('Product',
...
class Product(Base):
    ...
    image_product: Mapped[List['ImageProduct']] = relationship('ImageProduct',
                                                             back_populates='product',
                                                             cascade="all, delete-orphan")

    reviews_product: Mapped[List['Review']] = relationship('Review',
                                                          back_populates='Product',
                                                          cascade="all, delete-orphan")

    items_product: Mapped[List['CartItem']] = relationship('CartItem',
                                                          back_populates='product',
                                                           cascade="all, delete-orphan")

    favorite_product: Mapped[List['FavoriteItem']] = relationship('FavoriteItem',
                                                          back_populates='product',
                                                            cascade="all, delete-orphan")
    def __repr__(self):
...
class Review(Base):
    ...
    User: Mapped[UserProfile] = relationship('UserProfile', back_populates='reviews_user')
...
class CartItem(Base):
    ...
    product: Mapped[Product] = relationship('Product', back_populates='items_product')
...
class Favorite(Base):
    ...
    favorite_items: Mapped[List['FavoriteItem']] = relationship('FavoriteItem',
